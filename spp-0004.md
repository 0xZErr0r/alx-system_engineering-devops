...
- **USSD Authentication**: As the primary method of authentication, the user provides a code that has been sent to their phone via USSD as proof of their identity.
