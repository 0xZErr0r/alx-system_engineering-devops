...
- **USSD Authentication**: As the primary method of authentication, the system provides a code that has been sent to their phone via USSD as proof of their identity. (zero dependence on users action)

- **SMS Authentication**: When the USSD authentication fails, the user provides a code that has been sent to their phone via SMS as proof of their identity.
