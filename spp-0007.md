...
- Agent accounts have a public name that is similar to there private name, which is the agents actual "Full Name". And when the agent is not a person, the public name of this agent could be the "Trademark" OR "the Name used on the Business License" of that entity.
