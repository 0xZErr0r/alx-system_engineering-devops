...
![multiple account kyc pic](https://user-images.githubusercontent.com/57795945/152510518-35d59e86-7de7-43db-a4af-b41125d00680.PNG)
...
<br />
  ...
  done OTA (Over-The-Air). All the above KYC's for Silver Account are mandatory, but "referral" is unique to silver account.
  As users sign up for silver account using referral, users will be sent a specific amount of money (probably around 5 birr) 
  to smoothen the customer acquistion.
  ```
