...
## Description
Transactions happen between any two Smilepay accounts. There are many multiple types of transactions in the system because Smilepay has multiple accounts. Here is the format which all transactions follow:
