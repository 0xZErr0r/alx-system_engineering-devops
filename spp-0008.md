...
(a) *Personal accounts* have a public name called "Username", which they can create on their own. For username users can use a-z, 0-9 and underscores with a minimum length of 5-30 characters.
...
(a) When a smile id starts with the digit "555", it is a *personal account* smile id
...
Business account Smile ID has a maximum digit of 10 digits after the identifier digit 2, which means Smilepay can assign smile business ID to 9,999,999,999 (> 9.9 billion) businesses. The following shows how business smile ID grows from the start as it is assigned to more users:
```
2-000-000
2-000-001
2-000-002
...
2-000-000-000-00      --> "Business Smile ID" as it reach's 200 billion business account
     ...
     .
     .     
2-519*-***-***-**     --> Business Smile ID as it approach's similar digits that look like an Ethiopian phone number



2-519-113-677-27      --> An Ethiopian phone Number
```
