...
| ---------------------- | ---------------------------------------------- |
|         63             | Phone Authentication Service                   |
...
|  63008  | Unable To Fetch Phone Number                                  |
|  63009  | Internal Error Found                                          |
```
...
|  13005  | Unable To Get Block By Its Id From Block DB Controller        |
|  13006  | Unable To Get All Blocks For User Using The DB Controller     |
|  13007  | Unable To Save Block History                                  |
```
...
public enum PhoneAutheErrorCode {
    ...
    UNABLE_TO_FETCH_PN("0x63008"),
    Internal Error Found("0x63009");
...
public enum BlockErrorCode {
    ...
    UNABLE_TO_GET_ALL_USER_BLOCKS("0x13006"),
    UNABLE_TO_SAVE_BLOCK_HISTORY("0x13007"),
