...
|  63002  | Unable To Fetch Phone Number                                  |
|  63003  | Unable To Create Registration Token                           |
|  63004  | Unable To Create Authentication Permission Token              |
|  63005  | Unable To Check If Phone Number Exists                        |
|  63006  | Unable To Validate Phone Number                               |
|  63007  | Unable To Add New Phone Number                                |
|  63008  | Internal Error Found                                          |
|  63009  | Route Not Found                                               |
|  6300A  | Unauthorized                                                  |
|  6300B  | Input Error                                                   |
|  6300C  | Verification Error Code                                       |
|  6300D  | Invalid Verification Code                                     |
|  6300E  | Invalid Verification Token                                    |
|  6300F  | Invalid Phone Number                                          |
|  63010  | Try Again                                                     |
|  63011  | Unable To Check                                               |
...
public enum PhoneVerificationErrorCode {
    ...
    UNABLE_TO_FETCH_PN("0x63002"),
    UNABLE_TO_CREATE_REG_TOKEN("0x63003"),
    UNABLE_TO_CREATE_AUTH_TOKEN("0x63004"),
    UNABLE_TO_CHECK_PN_EXIST("0x63005"),
    UNABLE_TO_PN_VALID("0x63006"),
    UNABLE_TO_ADD_NEW_PN("0x63007"),
    INTERNAL_ERROR_FOUND("0x63008"),
    ROUTE_NOT_FOUND("0x63009"),
    UNAUTHORIZED("0x6300A"),
    INPUT_ERROR("0x6300B"),
    VERIFICATION_ERROR_CODE("0x6300C"),
    INVALID_VERIFICATION_CODE("0x6300D"),
    INVALID_VERIFICATION_TOKEN("0x6300E"),
    INVALID_PHONE_NUMBER("0x6300F"),
    TRY_AGAIN("0x63010"),
    UNABLE_TO_CHECK("0x63011"),
...
public enum RegistErrorCode {
    ...
    UNABLE_TO_VALIDATE_BEFORE_REGIST("0x49004"),
    UNABLE_TO_VALIDATE_PN("0x49005"),
    UNABLE_TO_EXTRACT_PN("0x49006")
    UNABLE_TO_ADD_USER("0x49007"),
    UNABLE_TO_ADD_PN_FOR_USER("0x49008"),
    Internal Error Found("0x49009");
