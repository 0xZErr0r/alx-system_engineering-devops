...
|  98003  | Unable To Create New JWT Auth Token                           |
|  98004  | Unable To Check If Refresh Token Exists Or Not                |
|  98005  | Unable To Fetch User Id By Refresh Token                      |
|  98006  | Unable To Check If A Session Exists                           |
|  98007  | Unable To Fetch User Data By Phone Number                     |
|  98008  | Internal Error Found                                          |
|  98009  | Route Not Found                                               |
|  9800A  | Unable To Fetch Data                                          |
|  9800B  | Unable To Check Data                                          |
|  9800C  | Unable To Delete                                              |
|  9800D  | Unable To Create                                              |
|  9800E  | Unable To Create Session                                      |
|  9800F  | Unauthorized                                                  |
|  98010  | Validation Error                                              |
```
...
|  Code   |                          Description                          |  
| ------- | ------------------------------------------------------------- |
|  47000  | Route Not Found                                               |
|  47001  | Unauthorized                                                  |
|  47002  | Internal Error                                                |
|  47003  | Account Error                                                 |
```
...
#### 16. Quota DB Controller
```
|  Error  |                             Error                             |
|  Code   |                          Description                          |  
| ------- | ------------------------------------------------------------- |
|  67000  | Bad Request                                                   |
|  67001  | Internal Error                                                |
|  67002  | Resource Not Found                                            |
|  67003  | Unauthorized                                                  |
|  67004  | Validation Error                                              |
```

#### 17. Exception Quota DB Controller
```
|  Error  |                             Error                             |
|  Code   |                          Description                          |  
| ------- | ------------------------------------------------------------- |
|  95000  | Bad Request                                                   |
|  95001  | Internal Error                                                |
|  95002  | Resource Not Found                                            |
|  95003  | Unauthorized                                                  |
|  95004  | Validation Error                                              |
```

#### 19. Block DB Controller
```
|  Error  |                             Error                             |
|  Code   |                          Description                          |  
| ------- | ------------------------------------------------------------- |
...
| ------- | ------------------------------------------------------------- |
// ApiErrorCode
|  77000  | Internal Server Error                                         |
|  77001  | Unauthorized                                                  |
// FCMTokenErrorCode
|  77002  | FCM Token Fetch Error                                         |
|  77003  | FCM Token Add Error                                           |
|  77004  | FCM Token Update Error                                        |
|  77005  | FCM Token Check Error                                         |
// NotificationErrorCode
|  77006  | Invalid ID                                                    |
|  77007  | Invalid Notification Type                                     |
|  77008  | Invalid Subject                                               |
|  77009  | Invalid Content                                               |
|  77010  | Notification Send Error                                       |
|  77011  | Notification New Token Add Error                              |
// NotificationHistoryErrorCode
|  77012  | Notification History Add Error                                |
// NotificationImageErrorCode
|  77013  | Notification Image Fetch Error                                |
|  77014  | Notification Image Add Error                                  |
// NotificationTypeErrorCode
|  77015  | Notification Type Check Error                                 |
|  77016  | Notification Type Fetch Error                                 |
// UsersErrorCode
|  77017  | User Fetch Error                                              |
|  77018  | User Add Error                                                |
|  77019  | User Check Error                                              |
// ConsumerErrorCode
|  77020  | Kafka Consume Error                                           |
// ProducerErrorCode
|  77021  | Kafka Produce Error                                           |
// SerializeErrorCode 
|  77022  | Serialize Error                                               |
|  77023  | Deserialize Error                                             |
```
...
public enum AuthErrorCode {
    ...
    INVALID_REFRESH_TOKEN("0x98000"),
    INVALID_AUTHORIZATION_TOKEN("0x98001"),
    UNABLE_TO_REMOVE_SESSION("0x98002"), 
    UNABLE_TO_CREATE_NEW_JWT_AUTHORIZATION_TOKEN("0x98003"),
    UNABLE_TO_CHECK_REFRESH_TOKEN_EXIST("0x98004"),
    UNABLE_TO_FETCH_USER_ID_BY_REFRESH_TOKEN("0x98005"),
    UNABLE_TO_CHECK_SESSION_EXIST("0x98006"),
    UNABLE_TO_FETCH_USER_DATA_BY_PN("0X98007"),
    INTERNAL_ERROR_FOUND("0x98008"),
    ROUTE_NOT_FOUND("0x98009"),
    UNABLE_TO_FETCH_DATA("0x9800A"),
    UNABLE_TO_CHECK_DATA("0x9800B"),
    UNABLE_TO_DELETE("0X9800C"),
    UNABLE_TO_CREATE("0x9800D"),
    UNABLE_TO_CREATE_SESSION("0x9800E"),
    UNAUTHORIZED("0x9800F"),
    VALIDATION_ERROR("0x98010");
...
public enum AccountErrorCode {
    ...
    ROUTE_NOT_FOUND("0x47000"),
    UNAUTHORIZED("0x47001"),
    INTERNAL_ERROR("0x47002"),
    ACCOUNT_ERROR("0x47003");
...
#### 16. Quota DB Controller
```
public enum QuotaDBErrorCode {

    BAD_REQUEST("0x67000"),
    INTERNAL_ERROR("0x67001"),
    RESOURCE_NOT_FOUND("0x67002"),
    UNAUTHORIZED("0x67003"),
    VALIDATION_ERROR("0x67004");
...
#### 17. Exception Quota DB Controller
``` 
public enum QuotaExceptionDBErrorCode {

    BAD_REQUEST("0x95000"),
    INTERNAL_ERROR("0x95001"),
    RESOURCE_NOT_FOUND("0x95002"),
    UNAUTHORIZED("0x95003"),
    VALIDATION_ERROR("0x95004");
...
public enum ApiErrorCode {
    INTERNAL_SERVER_ERROR("0x77000"), // TODO change code
    UNAUTHORIZED("0x77001"); // TODO change code
...
public enum FCMTokenErrorCode {
    FCM_TOKEN_FETCH_ERROR("0x77002"),
    FCM_TOKEN_ADD_ERROR("0x77003"),
    FCM_TOKEN_UPDATE_ERROR("0x77004"),
    FCM_TOKEN_CHECK_ERROR("0x77005"); // TODO change error code
...
public enum NotificationErrorCode {
    INVALID_ID("0x77006"),
    INVALID_NOTIFICATION_TYPE("0x77007"),
    INVALID_SUBJECT("0x77008"),
    INVALID_CONTENT("0x77009"),
    NOTIFICATION_SEND_ERROR("0x77010"),
    NOTIFICATION_NEW_TOKEN_ADD_ERROR("0x77011"); // TODO change error code
...
// NotificationHistoryErrorCode
```
public enum NotificationHistoryErrorCode {
    NOTIFICATION_HISTORY_ADD_ERROR("0x77012"); // TODO change error code
...
// NotificationImageErrorCode
```
public enum NotificationImageErrorCode {
    NOTIFICATION_IMAGE_FETCH_ERROR("0x77013"), // TODO change error code
    NOTIFICATION_IMAGE_ADD_ERROR("0x77014");
...
// NotificationTypeErrorCode
```
public enum NotificationTypeErrorCode {
    NOTIFICATION_TYPE_CHECK_ERROR("0x77015"),
    NOTIFICATION_TYPE_FETCH_ERROR("0x77016"); // TODO change error code
...
public enum UsersErrorCode {
    USER_FETCH_ERROR("0x77017"),
    USER_ADD_ERROR("0x77018"),
    USER_CHECK_ERROR("0x77019"); // TODO change error code
...
public enum ConsumerErrorCode {
    KAFKA_CONSUME_ERROR("0x77020"); // TODO change error code
...
public enum ProducerErrorCode {
    KAFKA_PRODUCE_ERROR("0x77021"); // TODO change error code
...
// SerializeErrorCode 
```
public enum SerializeErrorCode {
    SERIALIZE_ERROR("0x77022"),
    DESERIALIZE_ERROR("0x77023"); // TODO change error code
